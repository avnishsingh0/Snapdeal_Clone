...
const handleSubmit=(e)=>{
  ...
  <AccordionItem>
   ...
   <Text textAlign={'center'}>Logged in as <span>avnishbdp@gmail.com</span></Text>
   <Center>
   <Button bg={'#dc3545 '} color={'white'} m={'auto'} borderRadius={'0px'} w={'35%'} mt={5} >CONTINUE</Button>
   </Center>
    </AccordionPanel>
  </AccordionItem>
  ...
  <AccordionItem>
    ...
    <AccordionPanel pb={4}>
     ...
     <Input placeholder='Flat/House No. Colony/Street No.'  />
     </Box>
     <Box display={'flex'} mt={3} >
