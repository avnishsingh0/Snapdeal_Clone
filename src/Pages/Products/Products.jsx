...
import SinglegridProduct from "../../Components/Products/ProductCard";
...
const Products = () => {
  ...
  return (
    ...
    <div>
      ...
      <Flex justify="center">
        ...
        <Box width="full" minH={"80vh"}>
          {prod.length === 0 && !isLoading ? (
            <Flex justify={"center"} align="center" padding={"1rem"}>
              <Image
      ...
      <Flex pos={"fixed"} bottom="0" width={"80%"} display={{ md: "none" }}>
        <DrawerComponent
          brand={brand}
          setBrand={setBrand}
          category={category}
